...
public class LoginPage {
		...
		@FindBy(name = "username")WebElement userName;//Finds the username input box using its name attribute.
		@FindBy(name = "password")WebElement password;
		@FindBy(xpath = "//button[@type='submit']")WebElement signInBtn;//xpath
		...
		public void enterUserNameOnUserNamefield(String usernamevalue) { //Takes a String usernamevalue
			//Types that value inside the username field.
